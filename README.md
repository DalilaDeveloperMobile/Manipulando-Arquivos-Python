...
arquivo.close()
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Os Shutil:
```
import os
import shutil
...
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Tratamento Erro:
```
from pathlib import Path
...
#     print(f"Não foi possível abrir o arquivo: {exc}")
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Boas Praticas:
```
from pathlib import Path
...
try:
    ...
    print(exc)
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Csv:
```
import csv
from pathlib import Path
